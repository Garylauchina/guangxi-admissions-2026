...
if __name__=='__main__':
 api=PublicAPI('https://admission.sysu.edu.cn','sysu')
 api.query('score-params','f/ajax_lnfs_param',{})
 for year,track in [('2026','物理类'),('2026','历史类'),('2025','物理类')]:
  api.query('scores-'+year+'-'+track,'f/ajax_lnfs',{'ssmc':'广西','zsnf':year,'klmc':track,'zslx':'普通录取'})
