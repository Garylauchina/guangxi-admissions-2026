...
import { PLAN_GAPS, planGaps, isComparableMajorScore, comparableMajorCount } from './coverage.js?v=ba6e890eec43';

const $ = id => document.getElementById(id);
const fmt = n => Number(n).toLocaleString('zh-CN');
const YEAR = 2026;
const DATA_VERSION = '984e74f48e5c6af79498665f9dfd7f199f64547ac293c295e70f1ed385059b75';
...
const names={"cutoffs":"cutoffs","plans":"plans","majorCutoffs":"major-cutoffs","ranks":"ranks","special":"special-programs","sources":"sources","policies":"policies","coverage":"school-coverage","auditNotes":"school-audit-notes","planSources":"plan-source-catalog","supplementaryPlans":"supplementary-plans","majorFiling":"major-filing-cutoffs"};
